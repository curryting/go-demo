...
const (
	RecommendationMode_GetFarthest RecommendationMode = 0 // 最远开始
	RecommendationMode_GetNearest  RecommendationMode = 1 // 最近开始
)
...
type RouteSummary struct {
	...
	ElapsedTime int32 `protobuf:"varint,3,opt,name=elapsed_time,json=elapsedTime,proto3" json:"elapsed_time,omitempty"` // 用了多久时间
}
...
type RecommendationRequest struct {
	...
	Mode  RecommendationMode `protobuf:"varint,1,opt,name=mode,proto3,enum=route.RecommendationMode" json:"mode,omitempty"` // 记录想要哪个模式
	Point *Point             `protobuf:"bytes,2,opt,name=point,proto3" json:"point,omitempty"`                              // 查询的是哪个点的推荐
}
...
var file_route_proto_rawDesc = []byte{
	...
	0x47, 0x65, 0x74, 0x4e, 0x65, 0x61, 0x72, 0x65, 0x73, 0x74, 0x10, 0x01, 0x32, 0xe6, 0x01, 0x0a,
	...
	0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x00, 0x12, 0x33, 0x0a, 0x0b, 0x4c, 0x69, 0x73,
	0x74, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x10, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65,
	...
	0x22, 0x00, 0x28, 0x01, 0x12, 0x3f, 0x0a, 0x09, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x64, 0x12, 0x1c, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d,
	0x65, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x0e, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22,
	0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x1f, 0x5a, 0x1d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
...
var file_route_proto_depIdxs = []int32{
	...
	2, // 6: route.RouteGuide.ListFeature:input_type -> route.Rectangle
	...
	3, // 10: route.RouteGuide.ListFeature:output_type -> route.Feature
